...
public class init {
    ...
    public static void main(String[] args){
        ...
        double time_start, time_end, time_end2;
       ...
       System.out.println("Cantidad de Permutaciones: "+id);
      ...
      System.out.println("lista ordenada con los óptimos Temporales: "+"\r\n"+listaT);
       ...
       try {
      		escTxt( "Solucion","La Cantidad de Permutaciones son: "+id +"\r\n"+"\r\n"+
      				"El tiempo que tardaron las permutaciones es: "+( time_end - time_start )/1000 +" Segundos"+"\r\n"+
      				"El tiempo que tardo todo el código en ejecutarse(Despues del ordenamiento) es: "+( time_end2 - time_start )/1000+" Segundos"+"\r\n");
      	   } catch (IOException e) {
      		// TODO Auto-generated catch block
      		e.printStackTrace();
      	   }
       System.out.println("El tiempo que tardaron las permutaciones es "+ ( time_end - time_start )/1000 +" Segundos");
       System.out.println("El tiempo que tardo todo el código en ejecutarse(Despues del ordenamiento) es: "+ ( time_end2 - time_start )/1000 +" Segundos");
